function calculate() {
    ...
    var sample_density_kg_m3 = in_sg * water_density_kg_m3;
    var salt_kg = (sample_density_kg_m3 - water_density_kg_m3) * in_vol_m3;
    var salt_g = salt_kg * 1000.0;
    var salt_ml = salt_g / 2.16; // g / (cm^3=ml)
